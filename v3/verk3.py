...
class verk3:
    ...
    def inputToDict(self,filename):
        ...
        for line in file:
            ...
            if len(split) > 1:
                ...
                self.wholeNet.append([int(split[2]),split[0],split[1]])
            else:
        ...
        self.wholeNet.sort(reverse=True)
    ...
    def NotMinPRIM(self,G,w):
        ...
        for e in self.wholeNet:
            if binary_search(self.Span, e) == -1:
                self.notSpan.append(e)
